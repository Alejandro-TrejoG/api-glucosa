...
const HTMLmail = (nombre, tipoMuestra, concentracion) => {
  ...
  body {font-family: 'Chivo', sans-serif;}
    ...
    <![endif]-->
      ...
      <tbody>
        <tr>
          <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center">Hola ${nombre}...</div><div></div></div></td>
        </tr>
      </tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:18px 10px 18px 10px; line-height:32px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #79a6ff; font-size: 50px">¡Aqui tenemos el estado de tu glucosa!</span></div><div></div></div></td>
        </tr>
      </tbody>
  ...
  <div style="font-family: inherit; text-align: center"> </div><div></div></div></td>
      ...
      <tbody>
        <tr>
          <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
            <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:70% !important; width:70%; height:auto !important;" width="NaN" alt="" data-proportionally-constrained="true" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/4d01c2ecbe04fa16/8c83b9f7-543a-4950-894a-7db2af21392f/976x549.jpg">
          </td>
        </tr>
      </tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:40px 30px 18px 30px; line-height:32px; text-align:inherit; background-color:#000000;" height="100%" valign="top" bgcolor="#000000" role="module-content"><div><div style="font-family: inherit; text-align: center"></div>
  <div style="font-family: inherit; text-align: center"><span style="color: #ff8c85; font-size: 32px">Eso ha sido todo</span></div><div></div></div></td>
        </tr>
      </tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:0px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#000000;" height="100%" valign="top" bgcolor="#000000" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #ffffff">¡Nostros queremos que tu estes bien!</span></div><div></div></div></td>
        </tr>
      </tbody>
